...
<dict>
	...
	<string>%s/Library/Logs/atomcode-proxy.log</string>
...
func uninstallSystemd() error {
	exec.Command("systemctl", "--user", "stop", "atomcode-proxy").Run()
	exec.Command("systemctl", "--user", "disable", "atomcode-proxy").Run()
	home, _ := os.UserHomeDir()
	os.Remove(home + "/.config/systemd/user/atomcode-proxy.service")
	exec.Command("systemctl", "--user", "daemon-reload").Run()
