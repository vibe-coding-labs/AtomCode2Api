...
const ForgotPasswordPage: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <Card
        style={{ width: 640, borderRadius: 2, boxShadow: '0 8px 24px rgba(0,0,0,0.12)' }}
      ...
      >
        ...
        <Link to="/login">
          <Button icon={<ArrowLeftOutlined />} type="primary" ghost style={{ borderRadius: 3 }}>
            返回登录
          </Button>
        </Link>
      </Card>
